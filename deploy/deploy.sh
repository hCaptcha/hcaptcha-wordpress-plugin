...
PLUGINSLUG="hcaptcha-for-forms-and-more"
echo  "Q1. WordPress Repo Plugin Slug e.g. my-awesome-plugin: $PLUGINSLUG"
echo
...
default_svnuser="hcaptcha"
default_plugindir="$CURRENTDIR/hcaptcha-wordpress-plugin"
default_mainfile="hcaptcha.php"
