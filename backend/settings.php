...
if( isset( $_POST['hcaptcha_settings_nonce'] ) && wp_verify_nonce( $_POST['hcaptcha_settings_nonce'], 'hcaptcha_settings' ) && isset($_POST["submit"]) ){
    if(isset($_POST[$hcap_api_key_n])){
        ...
        update_option($hcap_api_key_n, sanitize_text_field( $hcap_api_key ) );
    }

    if(isset($_POST[$hcap_secret_key_n])){
        $hcap_secret_key           = $_POST[$hcap_secret_key_n];
        update_option($hcap_secret_key_n, sanitize_text_field( $hcap_secret_key ) );
    }

    if(isset($_POST[$hcap_theme_n])){
        $hcap_theme           = $_POST[$hcap_theme_n];
        update_option($hcap_theme_n, sanitize_text_field( $hcap_theme) );
    }

    if(isset($_POST[$hcap_size_n])){
        $hcap_size           = $_POST[$hcap_size_n];
        update_option($hcap_size_n, sanitize_text_field( $hcap_size) );
    }

    if(isset($_POST[$hcap_language_n])){
        $hcap_language           = $_POST[$hcap_language_n];
        update_option($hcap_language_n, sanitize_text_field( $hcap_language ) );
    }

    if(isset($_POST[$hcap_nf_status_n])){
        $hcap_nf_status         = $_POST[$hcap_nf_status_n];
        update_option($hcap_nf_status_n, sanitize_text_field( $hcap_nf_status ) );
    } else {
        $hcap_nf_status         = "off";
        update_option($hcap_nf_status_n, sanitize_text_field( $hcap_nf_status ) );
    }
    ...
    if(isset($_POST[$hcap_cf7_status_n])){
        ...
        update_option($hcap_cf7_status_n, sanitize_text_field( $hcap_cf7_status ) );
    } else {
        $hcap_cf7_status         = "off";
        update_option($hcap_cf7_status_n, sanitize_text_field( $hcap_cf7_status ) );
    }
    ...
    if(isset($_POST[$hcap_lf_status_n])){
        ...
        update_option($hcap_lf_status_n, sanitize_text_field( $hcap_lf_status ) );
    } else {
        $hcap_lf_status         = "off";
        update_option($hcap_lf_status_n, sanitize_text_field( $hcap_lf_status ) );
    }
    ...
    if(isset($_POST[$hcap_rf_status_n])){
        ...
        update_option($hcap_rf_status_n, sanitize_text_field( $hcap_rf_status ) );
    } else {
        $hcap_rf_status         = "off";
        update_option($hcap_rf_status_n, sanitize_text_field( $hcap_rf_status ) );
    }
    ...
    if(isset($_POST[$hcap_cmf_status_n])){
        ...
        update_option($hcap_cmf_status_n, sanitize_text_field( $hcap_cmf_status ) );
    } else {
        $hcap_cmf_status         = "off";
        update_option($hcap_cmf_status_n, sanitize_text_field( $hcap_cmf_status ) );
    }
    ...
    if(isset($_POST[$hcap_lpf_status_n])){
        ...
        update_option($hcap_lpf_status_n, sanitize_text_field( $hcap_lpf_status ) );
    } else {
        $hcap_lpf_status         = "off";
        update_option($hcap_lpf_status_n, sanitize_text_field( $hcap_lpf_status ) );
    }
    ...
    if(isset($_POST[$hcap_wc_login_status_n])){
        ...
        update_option($hcap_wc_login_status_n, sanitize_text_field( $hcap_wc_login_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_wc_reg_status_n])){
        ...
        update_option($hcap_wc_reg_status_n, sanitize_text_field( $hcap_wc_reg_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_wc_lost_pass_status_n])){
        ...
        update_option($hcap_wc_lost_pass_status_n, sanitize_text_field( $hcap_wc_lost_pass_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_wc_checkout_status_n])){
        ...
        update_option($hcap_wc_checkout_status_n, sanitize_text_field( $hcap_wc_checkout_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_bp_reg_status_n])){
        ...
        update_option($hcap_bp_reg_status_n, sanitize_text_field( $hcap_bp_reg_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_bp_create_group_status_n])){
        ...
        update_option($hcap_bp_create_group_status_n, sanitize_text_field( $hcap_bp_create_group_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_bbp_new_topic_status_n])){
        ...
        update_option($hcap_bbp_new_topic_status_n, sanitize_text_field( $hcap_bbp_new_topic_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_bbp_reply_status_n])){
        ...
        update_option($hcap_bbp_reply_status_n, sanitize_text_field( $hcap_bbp_reply_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_wpforo_new_topic_status_n])){
        ...
        update_option($hcap_wpforo_new_topic_status_n, sanitize_text_field( $hcap_wpforo_new_topic_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_wpforo_reply_status_n])){
        ...
        update_option($hcap_wpforo_reply_status_n, sanitize_text_field( $hcap_wpforo_reply_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_mc4wp_status_n])){
        ...
        update_option($hcap_mc4wp_status_n, sanitize_text_field( $hcap_mc4wp_status ) );
    } else {
    ...
    if(isset($_POST[$hcap_jetpack_cf_status_n])){
        ...
        update_option($hcap_jetpack_cf_status_n, sanitize_text_field( $hcap_jetpack_cf_status ) );
    } else {
