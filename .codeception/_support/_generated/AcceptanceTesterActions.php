<?php  //[STAMP] cf712ff3bb27a220f24c092e9ab6adac
...
trait AcceptanceTesterActions
{
     ...
     */
    public function havePageInDatabase($overrides = []) {
     ...
     * @see \Codeception\Module\WPDb::havePostInDatabase()
     */
    public function havePostInDatabase($data = []) {
     ...
     */
    public function haveTermInDatabase($name, $taxonomy, $overrides = []) {
     ...
     */
    public function haveManyPostsInDatabase($count, $overrides = []) {
     ...
     */
    public function dontHaveTermInDatabase($criteria, $purgeMeta = true) {
     ...
     */
    public function haveManyCommentsInDatabase($count, $comment_post_ID, $overrides = []) {
     ...
     */
    public function haveCommentInDatabase($comment_post_ID, $data = []) {
     ...
     */
    public function countRowsInDatabase($table, $criteria = []) {
     ...
     */
    public function dontHaveCommentInDatabase($criteria, $purgeMeta = true) {
     ...
     */
    public function haveManyLinksInDatabase($count, $overrides = []) {
     ...
     */
    public function haveLinkInDatabase($overrides = []) {
     ...
     */
    public function haveManyUsersInDatabase($count, $user_login, $role = "subscriber", $overrides = []) {
     ...
     */
    public function haveUserInDatabase($user_login, $role = "subscriber", $overrides = []) {
     ...
     */
    public function haveManyTermsInDatabase($count, $name, $taxonomy, $overrides = []) {
     ...
     */
    public function haveManyBlogsInDatabase($count, $overrides = [], $subdomain = true) {
     ...
     */
    public function haveBlogInDatabase($domainOrPath, $overrides = [], $subdomain = true) {
     ...
     */
    public function dontHaveBlogInDatabase($criteria, $removeTables = true, $removeUploads = true) {
     ...
     */
    public function haveMenuInDatabase($slug, $location, $overrides = []) {
     ...
     */
    public function haveMenuItemInDatabase($menuSlug, $title, $menuOrder = NULL, $meta = []) {
     ...
     */
    public function haveAttachmentInDatabase($file, $date = "now", $overrides = [], $imageSizes = NULL) {
     ...
     */
    public function dontHaveAttachmentInDatabase($criteria, $purgeMeta = true, $removeFiles = false) {
     ...
     */
    public function dontHavePostInDatabase($criteria, $purgeMeta = true) {
