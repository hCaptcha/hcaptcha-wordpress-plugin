	...
	public function init_form_fields() {
		$this->form_fields = [
			...
			'api_host'             => [
				...
				'helper'  => __( 'Hostname hCaptcha api.js is loaded from.', 'hcaptcha-for-forms-and-more' ),
			],
			'asset_host'           => [
				'label'   => __( 'Asset Host', 'hcaptcha-for-forms-and-more' ),
				'type'    => 'text',
				'section' => self::SECTION_ENTERPRISE,
				'helper'  => __( 'Asset host for hCaptcha api.js.', 'hcaptcha-for-forms-and-more' ),
			],
			'endpoint'             => [
				'label'   => __( 'Endpoint', 'hcaptcha-for-forms-and-more' ),
				'type'    => 'text',
				'section' => self::SECTION_ENTERPRISE,
				'helper'  => __( 'Endpoint for hCaptcha api.js.', 'hcaptcha-for-forms-and-more' ),
			],
			'host'                 => [
				'label'   => __( 'Host', 'hcaptcha-for-forms-and-more' ),
				'type'    => 'text',
				'section' => self::SECTION_ENTERPRISE,
				'helper'  => __( 'Host for hCaptcha api.js.', 'hcaptcha-for-forms-and-more' ),
			],
			'image_host'           => [
			...
			'report_api'           => [
				...
				'type'    => 'text',
				'section' => self::SECTION_ENTERPRISE,
				'helper'  => __( 'Report API for hCaptcha api.js.', 'hcaptcha-for-forms-and-more' ),
			],
			'sentry'               => [
				'label'   => __( 'Sentry', 'hcaptcha-for-forms-and-more' ),
				'type'    => 'text',
				'section' => self::SECTION_ENTERPRISE,
				'helper'  => __( 'Sentry for hCaptcha api.js.', 'hcaptcha-for-forms-and-more' ),
			],
			'off_when_logged_in'   => [
