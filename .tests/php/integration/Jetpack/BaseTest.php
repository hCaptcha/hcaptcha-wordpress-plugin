...
class BaseTest extends HCaptchaWPTestCase {
	...
	public function test_verify(): void {
		$this->prepare_hcaptcha_verify_post( 'hcaptcha_jetpack_nonce', 'hcaptcha_jetpack' );
	...
	public function test_verify_not_verified(): void {
		...
		$this->prepare_hcaptcha_verify_post( 'hcaptcha_jetpack_nonce', 'hcaptcha_jetpack', false );
