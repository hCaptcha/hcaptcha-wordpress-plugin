...
class LoginTest extends HCaptchaPluginWPTestCase {
	...
	public function test_verify(): void {
		...
		$this->prepare_hcaptcha_verify_post( "hcaptcha_um_{$mode}_nonce", "hcaptcha_um_$mode" );
	...
	public function test_verify_not_verified(): void {
		...
		$this->prepare_hcaptcha_verify_post( "hcaptcha_um_{$mode}_nonce", "hcaptcha_um_$mode", false );
