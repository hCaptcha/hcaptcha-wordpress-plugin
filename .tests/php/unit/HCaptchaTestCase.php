	...
	protected function get_test_general_form_fields(): array {
		$form_fields = [
			...
			'api_host'                 => [
				...
				'helper'  => 'Hostname hCaptcha api.js is loaded from.',
			],
			'asset_host'               => [
				'label'   => 'Asset Host',
				'type'    => 'text',
				'section' => 'enterprise',
				'helper'  => 'Asset host for hCaptcha api.js.',
			],
			'endpoint'                 => [
				'label'   => 'Endpoint',
				'type'    => 'text',
				'section' => 'enterprise',
				'helper'  => 'Endpoint for hCaptcha api.js.',
			],
			'host'                     => [
				'label'   => 'Host',
				'type'    => 'text',
				'section' => 'enterprise',
				'helper'  => 'Host for hCaptcha api.js.',
			],
			'image_host'               => [
				'label'   => 'Image Host',
				'type'    => 'text',
			...
			'report_api'               => [
				...
				'type'    => 'text',
				'section' => 'enterprise',
				'helper'  => 'Report API for hCaptcha api.js.',
			],
			'sentry'                   => [
				'label'   => 'Sentry',
				'type'    => 'text',
				'section' => 'enterprise',
				'helper'  => 'Sentry for hCaptcha api.js.',
			],
			'off_when_logged_in'       => [
