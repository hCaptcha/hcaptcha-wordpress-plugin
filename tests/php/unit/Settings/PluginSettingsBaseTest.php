...
class PluginSettingsBaseTest extends HCaptchaTestCase {
	...
	public function test_admin_footer_text(): void {
		...
		$text     = 'Some text';
		$expected = 'Please rate <strong>hCaptcha for WP</strong> <a href="https://wordpress.org/support/plugin/hcaptcha-for-forms-and-more/reviews/#new-post" target="_blank" rel="noopener noreferrer">★★★★★</a> on <a href="https://wordpress.org/support/plugin/hcaptcha-for-forms-and-more/reviews/#new-post" target="_blank" rel="noopener noreferrer">WordPress.org</a>. Thank you!';
